...
class DistributorPublisherImpl : DistributorPublisher {
    ...
    override fun placeOrder(order: Order): Boolean {
        ...
        template.convertAndSend(topic.name, "distributor.placeOrder.starikovamari.${order.id}", massage) {
            it.messageProperties.headers["Notify-Exchange"] = "distributor_exchange"
            it.messageProperties.headers["Notify-RoutingKey"] = "retailer.starikovamari"
            it
        }
        return true
